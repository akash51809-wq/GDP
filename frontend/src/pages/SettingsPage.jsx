...
import { Settings, ShieldCheck, PlugZap, Database, UserRound, MessageCircle, Mail, SlidersHorizontal, Save, RotateCcw } from "lucide-react";
  ...
  return (
    <main className="content settings-page">
      <div className="module-page-header settings-main-head">
        <div><div className="eyebrow">SYSTEM CONTROL</div><h1>Settings <span>✦</span></h1><p>Manage WhatsApp, Email SMTP and general application preferences.</p></div>
        <button className="settings-reset" onClick={reset}><RotateCcw size={13}/> Reset</button>
      </div>

      <section className="settings-overview">
        <div className="setting-mini"><div className="setting-mini-icon whatsapp"><MessageCircle size={18}/></div><div><small>WHATSAPP</small><b>URL Integration</b><span>API connection & sender</span></div></div>
        <div className="setting-mini"><div className="setting-mini-icon email"><Mail size={18}/></div><div><small>EMAIL</small><b>SMTP Settings</b><span>Outgoing mail server</span></div></div>
        <div className="setting-mini"><div className="setting-mini-icon general"><SlidersHorizontal size={18}/></div><div><small>GENERAL</small><b>System Preferences</b><span>Core application settings</span></div></div>
      </section>
